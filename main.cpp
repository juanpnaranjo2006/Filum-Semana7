...
public:
	...
	void abrirMalla(int i, char*nombreMalla) 
	{
		modelos[i] = NULL;
		if (!modelos[i])
		{
			modelos[i] = glmReadOBJ(nombreMalla);
			if (!modelos[i])
				exit(0);
	...
	virtual void OnRender(void)
	{
      ...
      if (shader) shader->begin();
		  ...
		  glmDraw(modelos[0], GLM_SMOOTH | GLM_MATERIAL);
		  glPopMatrix();

		  glPushMatrix();
		  glTranslatef(0.0f, 0.0f, 0.0f);
		  glmDraw(modelos[1], GLM_SMOOTH | GLM_MATERIAL);
		  glPopMatrix();
	      //glutSolidTeapot(1.0);
	  ...
	  if (shader1) shader1->begin();
		  ...
		  glmDraw(modelos[2], GLM_SMOOTH | GLM_MATERIAL | GLM_TEXTURE);
		  glPopMatrix();
	  //glutSolidTeapot(1.0);
	...
	virtual void OnInit()
	{
	 ...
	 //*** Para Textura: abre los shaders para texturas
	  ...
	  //Abrir mallas
	  abrirMalla(0, "./Mallas/mica.obj");

	  //Abrir mallas
	  abrirMalla(1, "./Mallas/dragon.obj");


	  //*** Para Textura: abrir malla de objeto a texturizar
	  abrirMalla(2, "./Mallas/bola.obj");
 
	  //*** Para Textura: abrir archivo de textura
	  initialize_textures(0, "./Mallas/bola.jpg");
      DemoLight();
